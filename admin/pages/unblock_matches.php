...
$mainTitle = $i18n->getMessage("category_unblock_matches_navlabel");
...
elseif ($show == "generate") {
	...
	try {
		$updStr = "UPDATE " . $website->getConfig("db_prefix") . "_spiel SET blocked='0' WHERE berechnet='0'";
        $result = $db->executeQuery($updStr);
