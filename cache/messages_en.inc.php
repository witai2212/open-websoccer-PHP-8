...
'fanpressure_navlabel' => 'Fan mood &amp; media',
'fanpressure_title' => 'Fan mood &amp; media',
'fanpressure_intro' => 'Shows how fans and media react to your work. These values influence attendance, fan-based sponsor bonuses and board satisfaction.',
'fanpressure_fan_mood' => 'Fan mood',
'fanpressure_media_pressure' => 'Media pressure',
'fanpressure_board_satisfaction' => 'Board satisfaction',
'fanpressure_attendance_effect' => 'Attendance effect',
'fanpressure_sponsor_effect' => 'Fan sponsor effect',
'fanpressure_recent_development' => 'Recent development',
'fanpressure_no_log' => 'No mood events yet.',
'fanpressure_value_good' => 'positive',
'fanpressure_value_neutral' => 'neutral',
'fanpressure_value_bad' => 'critical',
'fanpressure_points' => 'points',
'fanpressure_change' => 'Change',
'fanpressure_date' => 'Date',
'fanpressure_reason' => 'Reason',
'fanpressure_old_new' => 'Old / new',
'fanpressure_media_old_new' => 'Media old / new',
'fanpressure_match_link' => 'Match',
'fanpressure_low_hint' => 'Fan mood is tense.',
'fanpressure_high_hint' => 'The fans are behind the club.',
'fanpressure_neutral_hint' => 'The situation is calm.',
'fanpressure_reason_match_win' => 'Win',
'fanpressure_reason_match_draw' => 'Draw',
'fanpressure_reason_match_loss' => 'Loss',
'fanpressure_reason_big_win' => 'Big win',
'fanpressure_reason_big_loss' => 'Big loss',
'fanpressure_reason_derby_win' => 'Derby win',
'fanpressure_reason_derby_draw' => 'Derby draw',
'fanpressure_reason_derby_loss' => 'Derby loss',
'fanpressure_reason_youth_used' => 'Young players used',
'fanpressure_reason_ticket_prices_high' => 'High ticket prices',
'fanpressure_reason_ticket_prices_low' => 'Fan-friendly ticket prices',
'fanpressure_reason_transfer_signing' => 'Signing',
'fanpressure_reason_transfer_sale' => 'Player sale',
'fanpressure_reason_mission_completed' => 'Board objective completed',
'fanpressure_reason_mission_failed' => 'Board objective failed',
'fanpressure_reason_board_mood_bonus' => 'Very good fan mood',
'fanpressure_reason_board_mood_penalty' => 'Critical fan mood',
'fanpressure_notification_big_change' => 'Fan mood changed significantly: {reason} ({change} points, now {mood}%).',
'fanpressure_news_low_title' => 'Fan crisis at {team}',
'fanpressure_news_low_message' => 'Fan mood at {team} is critical. The current mood is only {mood} percent.',
'fanpressure_news_high_title' => 'Fan euphoria at {team}',
'fanpressure_news_high_message' => 'Fans at {team} are delighted. The current mood is a strong {mood} percent.',
'news_navlabel' => 'News',
'news_title' => 'News',
...
'manager-missions_navlabel' => 'Board',
'manager-missions_title' => 'Board / Season Objectives',
'manager-missions_intro' => 'The board evaluates the season by several short-term objectives.',
'manager_mission_no_active_season' => 'There is currently no active season for your club.',
'manager_mission_no_missions' => 'No missions have been created for this season yet.',
'manager_mission_season' => 'Season',
'manager_mission_summary' => 'Progress',
'manager_mission_completed_short' => 'completed',
'manager_mission_board_satisfaction' => 'Board satisfaction',
'manager_mission_highscore' => 'Highscore',
'manager_mission_rewards_hint' => 'Reward per completed objective:',
'manager_mission_penalty_hint' => 'Penalty per failed objective at season end:',
'manager_mission_baseline' => 'Baseline',
'manager_mission_target' => 'Target',
'manager_mission_current' => 'Current',
'manager_mission_status_open' => 'Open',
'manager_mission_status_completed' => 'Completed',
'manager_mission_status_failed' => 'Failed',
'manager_mission_title_league_rank' => 'Reach league position {rank}',
'manager_mission_desc_league_rank' => 'The board expects at least position {rank}.',
'manager_mission_title_highscore' => 'Improve highscore to {target}',
'manager_mission_desc_highscore' => 'Increase the club highscore from {baseline} to at least {target}.',
'manager_mission_title_salary_reduce' => 'Reduce player salaries to {target}',
'manager_mission_desc_salary_reduce' => 'Reduce player salaries from {baseline} to at most {target}.',
'manager_mission_salary_missing_detail' => 'Still need to save {amount} salary.',
'manager_mission_title_youth_promotion_played' => 'Promote and play a youth player',
'manager_mission_desc_youth_promotion_played' => 'Promote one youth player and play him at least once in a competitive match.',
'manager_mission_youth_open_detail' => 'No youth player has been promoted for this objective yet.',
'manager_mission_youth_promoted_detail' => '{player} was promoted. One competitive appearance is still missing.',
'manager_mission_youth_done_detail' => '{player} was promoted and played.',
'manager_mission_title_cup_round' => 'Reach cup round {round}',
'manager_mission_desc_cup_round' => 'Reach at least round {round} in any cup competition.',
'manager_mission_title_board_satisfaction' => 'Keep board above {target}%',
'manager_mission_desc_board_satisfaction' => 'Keep board satisfaction at least at {target}%.',
'manager_mission_value_rank' => 'Rank {rank}',
'manager_mission_value_cup_round' => 'Round {round}',
'manager_mission_value_done' => 'Done',
'manager_mission_value_open' => 'Open',
'manager_mission_completed_notification' => 'Season objective completed: {mission}',
'manager_mission_failed_notification' => 'Season objective failed: {mission}',
'manager_mission_news_completed_title' => 'Season objective completed at {team}',
'manager_mission_news_completed_message' => '{manager} completed a board objective with {team}: {mission}.',
'manager_mission_news_link' => 'Season objectives',
...
'merchandising_intro' => '
		Manage your merchandising assortment. After every home match, merchandising sales are calculated based on attendance, fan popularity, match result, pricing strategy and fan shop expansion.
	',
'merchandising_summary_title' => 'Overall summary',
'merchandising_summary_units_sold' => 'Items sold',
'merchandising_summary_revenue' => 'Revenue',
'merchandising_summary_costs' => 'Production costs',
'merchandising_summary_profit' => 'Profit',
'merchandising_summary_matches_with_sales' => 'Home matches with sales',
'merchandising_summary_avg_profit_per_match' => 'Average profit per home match',
'merchandising_products_title' => 'Assortment and pricing strategy',
'merchandising_product_name' => 'Product',
'merchandising_product_purchase_price' => 'Purchase price',
'merchandising_product_base_sales_price' => 'Base sales price',
'merchandising_product_effective_sales_price' => 'Current sales price',
'merchandising_product_profit_per_item' => 'Profit per item',
'merchandising_product_base_demand' => 'Base demand',
'merchandising_product_settings' => 'Settings',
'merchandising_product_enabled' => 'Offer product',
'merchandising_product_price_factor' => 'Price factor',
'merchandising_no_products_available' => '
		There are currently no active merchandising products available.
	',
'merchandising_product_statistics_title' => 'Statistics by product',
'merchandising_no_sales_statistics' => '
		No merchandising sales statistics are available yet.
	',
'merchandising_recent_sales_title' => 'Latest merchandising sales',
'merchandising_recent_sales_date' => 'Date',
'merchandising_recent_sales_match' => 'Match',
'merchandising_no_recent_sales' => '
		No merchandising sales have been recorded yet.
	',
'merchandising_matchday_profit_subject' => 'Merchandising profit from home match',
'merchandising_matchday_loss_subject' => 'Merchandising loss from home match',
...
'playertable_head_personality' => 'Personality',
...
'player_personality_unknown' => 'Unknown',
'player_personality_leader' => 'Leader',
'player_personality_professional' => 'Professional',
'player_personality_injury_prone' => 'Injury-prone',
'player_personality_inconsistent' => 'Inconsistent',
'player_personality_loyal' => 'Loyal',
'player_personality_ambitious' => 'Ambitious',
'player_personality_big_game_player' => 'Big-game player',
'player_personality_troublemaker' => 'Troublemaker',
...
'board_satisfaction_title' => 'Board satisfaction',
'board_info_season_target' => 'Season objectives',
'board_info_season_ranking' => 'Ranking',
'board_info_season_targethighscore' => 'Highscore',
'userprofile_block_board_title' => 'Board',
'userprofile_block_board_details' => 'View season objectives',
'userprofile_block_board_no_active_season' => 'There is currently no active season for your club.',
'userprofile_block_club_highscore' => 'Club highscore',
'random-events_navlabel' => 'Events',
'random-events_title' => 'Club Events',
'random-events_intro' => 'This page shows active events that need a manager decision. Some decisions apply immediately, others remain active until the event expires.',
'randomevent_chain_notification' => 'New club event: {event}',
'randomevent_chain_no_open_events' => 'There are currently no open club events.',
'randomevent_chain_expires_matchday' => 'Expires after matchday',
'randomevent_chain_choice' => 'Decision',
'randomevent_chain_effect' => 'Effect',
'randomevent_chain_choose' => 'Choose',
'randomevent_chain_choice_selected' => 'Selected reaction',
'randomevent_chain_waiting_until_expiry' => 'This reaction remains active until the event expires.',
'randomevent_chain_resolved_success' => 'The decision has been applied.',
'randomevent_chain_already_resolved' => 'This event has already been resolved.',
'randomevent_chain_already_selected' => 'A reaction has already been selected for this event.',
'randomevent_chain_player_unhappy_title' => 'Unhappy player',
'randomevent_chain_player_unhappy_message' => '{playername} seems increasingly unhappy. The situation may affect his happiness and the club atmosphere.',
'randomevent_chain_choice_talk' => 'Talk to the player',
'randomevent_chain_choice_talk_desc' => 'Costs some money for a personal talk and support, but improves his happiness.',
'randomevent_chain_choice_ignore' => 'Ignore',
'randomevent_chain_choice_ignore_desc' => 'No direct cost, but happiness drops and the board is slightly irritated.',
'randomevent_chain_choice_sell' => 'Put on transfer list',
'randomevent_chain_choice_sell_desc' => 'The player is placed on the transfer market. His happiness drops slightly.',
'randomevent_chain_sponsor_scandal_title' => 'Sponsor scandal',
'randomevent_chain_sponsor_scandal_message' => 'Your sponsor {sponsorname} is facing public criticism. The club must decide how to react.',
'randomevent_chain_choice_distance' => 'Distance the club',
'randomevent_chain_choice_distance_desc' => 'Costs money, but protects fan and board satisfaction.',
'randomevent_chain_choice_support' => 'Support the sponsor',
'randomevent_chain_choice_support_desc' => 'Brings short-term money, but hurts fans and the board.',
'randomevent_chain_choice_silent' => 'No statement',
'randomevent_chain_choice_silent_desc' => 'No direct cost, but fans and board react negatively.',
'randomevent_chain_youth_discovered_title' => 'Youth player discovered',
'randomevent_chain_youth_discovered_message' => 'A local scout recommends {youthplayer}, age {youth_age}, position {youth_position}. The player could join your youth team.',
'randomevent_chain_choice_sign_youth' => 'Sign youth player',
'randomevent_chain_choice_sign_youth_desc' => 'The player joins your youth team. A small training compensation is due.',
'randomevent_chain_choice_let_go' => 'Let him go',
'randomevent_chain_choice_let_go_desc' => 'No effect.',
'randomevent_chain_stadium_damage_title' => 'Stadium damage',
'randomevent_chain_stadium_damage_message' => 'Damage has been detected at {teamname}\'s stadium. You can repair it immediately or risk lower attendance.',
'randomevent_chain_choice_repair_now' => 'Repair now',
'randomevent_chain_choice_repair_now_desc' => 'High repair cost, but no further restriction.',
'randomevent_chain_choice_risk_attendance' => 'Postpone repair',
'randomevent_chain_choice_risk_attendance_desc' => 'No immediate cost, but attendance rate drops until the event expires.',
'randomevent_chain_choice_emergency_repair' => 'Emergency repair',
'randomevent_chain_choice_emergency_repair_desc' => 'If no decision is made in time, an expensive emergency repair is needed and the board is unhappy.',
'rivalries_derby_building_income_subject' => 'Derby-Bonus Stadionumfeld',
...
'sponsor_contractduraction_info' => 'Choose a sponsor contract until the end of the season. You can negotiate offers, but the sponsor may withdraw if the risk becomes too high.',
...
'sponsor_choose_novalidsponsor' => 'The selected sponsor does not want to collaborate any more. Probably another team was faster or the offer is no longer valid.',
'sponsor_choose_stillcontract' => 'You still have a contract with a sponsor. This contract runs until the end of the season.',
...
'sponsor_cup_bonus_subject' => 'Sponsor premium for cup round',
'sponsor_offer_type' => 'Contract type',
'sponsor_offer_type_safe' => 'Safe',
'sponsor_offer_type_risky' => 'Risky',
'sponsor_offer_type_fan' => 'Fan-based',
'sponsor_offer_type_cup' => 'Cup',
'sponsor_offer_type_legacy' => 'Legacy contract',
'sponsor_offer_description_safe' => 'High fixed income, but lower success bonuses.',
'sponsor_offer_description_risky' => 'Low fixed income, but high win and title bonuses.',
'sponsor_offer_description_fan' => 'Additional bonus based on stadium occupancy for home matches.',
'sponsor_offer_description_cup' => 'Stronger focus on cup matches and reached cup rounds.',
'sponsor_attendance_bonus_percent' => 'Attendance bonus',
'sponsor_contract_duration' => 'Duration',
'sponsor_contract_duration_season' => 'until season end',
'sponsor_negotiate_button' => 'Negotiate',
'sponsor_negotiation_level' => 'Negotiation level %d',
'sponsor_withdraw_chance' => 'Withdrawal risk when negotiating again: %d %%',
'sponsor_negotiation_success' => 'The negotiation was successful. The offer was improved.',
'sponsor_negotiation_withdrawn' => 'The sponsor withdrew. This offer is no longer available.',
...
'stadium_attendance_title' => 'Attendance statistics',
'stadium_attendance_intro' => 'Recent home matches with spectators, utilization, average prices and revenue per category. New matches use stored values; older matches are estimated from current stadium/ticket data.',
'stadium_attendance_average_title' => 'Average of latest matches',
'stadium_attendance_recent_title' => 'Latest home matches',
'stadium_attendance_no_matches' => 'No home matches with attendance data yet.',
'stadium_attendance_match' => 'Match',
'stadium_attendance_category' => 'Category',
'stadium_attendance_visitors' => 'Visitors',
'stadium_attendance_capacity' => 'Capacity',
'stadium_attendance_utilization' => 'Utilization',
'stadium_attendance_average_price' => 'Avg. price',
'stadium_attendance_revenue' => 'Revenue',
'stadium_attendance_standing' => 'Standing',
'stadium_attendance_seating' => 'Seating',
'stadium_attendance_vip' => 'VIP',
'stadium_attendance_total' => 'Total',
'stadium_attendance_against' => 'against',
'stadium_attendance_legacy_hint' => 'Old match: categories and prices estimated from current stadium/ticket data. New matches are stored exactly.',
'stadium-attendance_navlabel' => 'Spectator numbers',
...
'stadiumenvironment_effect_injury_unit' => 'match(es)',
'stadiumfacility_youthacademy_name' => 'Youth Academy',
'stadiumfacility_youthacademy_desc' => 'Improves youth development and increases the chance of stronger youth players.',
'stadiumfacility_medicalcenter_name' => 'Medical Center',
'stadiumfacility_medicalcenter_desc' => 'Better diagnosis and rehabilitation reduce player injury durations.',
'stadiumfacility_trainingcenter_name' => 'Training Center',
'stadiumfacility_trainingcenter_desc' => 'Modern training pitches and analysis areas improve training effects.',
'stadiumfacility_fanshop_name' => 'Fan Shop',
'stadiumfacility_fanshop_desc' => 'Increases merchandising sales on home matchdays and adds extra revenue.',
'stadiumfacility_mediacenter_name' => 'Media Center',
'stadiumfacility_mediacenter_desc' => 'Professional media work improves fan popularity and sponsor-related home match revenue.',
'stadiumfacility_viplounge_name' => 'VIP Lounge',
'stadiumfacility_viplounge_desc' => 'Improves hospitality, ticket demand and home match revenue.',
'stadiumfacility_pitchheating_name' => 'Pitch Heating',
'stadiumfacility_pitchheating_desc' => 'Improves pitch conditions, stabilizes attendance and reduces injury impact.',
'stadiumfacility_scoutingoffice_name' => 'Scouting Office',
'stadiumfacility_scoutingoffice_desc' => 'Improves youth scouting and the quality of new scouting proposals.',
...
'Abstieg' => 'Relegation',
'Meister' => 'Champion',
'teamchemistry_navlabel' => 'Team chemistry',
'teamchemistry_title' => 'Team chemistry',
'teamchemistry_intro' => 'Team chemistry shows how well your squad works as a unit. It is based on nationality, time at club, formation familiarity, captain, transfers, happiness and personality.',
'teamchemistry_schema_missing' => 'The database columns for team chemistry are missing. Please run the SQL update first.',
'teamchemistry_score' => 'Chemistry',
'teamchemistry_match_effect' => 'Match effect',
'teamchemistry_match_effect_help' => 'Small effect on passing, morale and match stability.',
'teamchemistry_factor' => 'Factor',
'teamchemistry_value' => 'Value',
'teamchemistry_detail' => 'Details',
'teamchemistry_recent_development' => 'Recent development',
'teamchemistry_no_log' => 'No chemistry development stored yet.',
'teamchemistry_date' => 'Date',
'teamchemistry_source' => 'Source',
'teamchemistry_old_new' => 'Old / new',
'teamchemistry_change' => 'Change',
'teamchemistry_value_good' => 'well connected',
'teamchemistry_value_neutral' => 'solid',
'teamchemistry_value_bad' => 'unsettled',
'teamchemistry_hint_good' => 'Your team is well connected. This can give small advantages in passing, morale and stability.',
'teamchemistry_hint_neutral' => 'Chemistry is solid. More continuity in formation, squad and captain can improve it.',
'teamchemistry_hint_bad' => 'Chemistry is low. Many new transfers, unhappy players or little familiarity can make the team less stable.',
'teamchemistry_factor_nationality' => 'Nationality',
'teamchemistry_factor_settled' => 'Time at club',
'teamchemistry_factor_formation' => 'Formation',
'teamchemistry_factor_captain' => 'Captain',
'teamchemistry_factor_transfers' => 'New transfers',
'teamchemistry_factor_happiness' => 'Happiness',
'teamchemistry_factor_personality' => 'Personality',
'teamchemistry_source_page' => 'Page view',
'teamchemistry_source_match' => 'Match preparation',
'teamchemistry_source_runtime' => 'Live simulation',
'teamchemistry_source_match_completed' => 'Match completed',
'teamchemistry_source_manual' => 'Update',
'teamchemistry_factor_trainingcamp' => 'Training camp',
'teamchemistry_source_trainingcamp' => 'Training camp',
...
'trainingcamp_type_balanced' => 'Balanced',
'trainingcamp_type_fitness' => 'Fitness',
'trainingcamp_type_recovery' => 'Recovery',
'trainingcamp_type_technique' => 'Technique',
'trainingcamp_type_teambuilding' => 'Team building',
'trainingcamp_type_tactics' => 'Tactics',
'trainingcamp_type_youth' => 'Youth development',
'trainingcamp_type_mental' => 'Mental',
'trainingcamp_players_included' => 'Players in camp',
'trainingcamp_total_costs' => 'Total costs',
'trainingcamp_estimated_min_costs' => 'Costs at minimum duration',
'trainingcamp_all_players_note' => 'The training camp applies to all active squad players. Effects are applied only after the team returns.',
'trainingcamp_last_report' => 'Latest training camp report',
'trainingcamp_report_completed_title' => 'Training camp completed',
'trainingcamp_report_completed_text' => 'The effects have been applied to the squad and a report has been created.',
'trainingcamp_report_period' => 'Period',
'trainingcamp_report_players_costs' => 'Players / costs',
'trainingcamp_report_effects' => 'Total effects',
'trainingcamp_special_effects' => 'Additional attributes',
'trainingcamp_report_special_effects' => 'Additional attributes total',
'trainingcamp_report_injuries' => 'New injuries',
...
'transfermarket_filter_advanced' => 'Advanced Search',
'transfermarket_filter_attribute' => 'Attribute',
...
'transfermarket_offerscount' => '%d offers for players',
