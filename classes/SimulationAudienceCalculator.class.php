...
class SimulationAudienceCalculator {
	...
	public static function computeAndSaveAudience(WebSoccer $websoccer, DbConnection $db, SimulationMatch $match) {
		...
		// store historical stadium attendance snapshot
		StadiumAttendanceDataService::saveMatchAttendance($websoccer, $db, $match, $homeInfo,
				$tickets_stands, $tickets_seats, $tickets_stands_grand, $tickets_seats_grand, $tickets_vip);
