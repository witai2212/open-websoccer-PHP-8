...
class SimulationPlayer {
	 ...
	 * @var int strength attribute: satisfaction (in per cent)
	 */
	public $strengthPassing;
	
	/**
	 * @var int strength attribute: satisfaction (in per cent)
	 */
	public $strengthShooting;
	
	/**
	 * @var int strength attribute: satisfaction (in per cent)
	 */
	public $strengthTackling;
	
	/**
	 * @var int strength attribute: satisfaction (in per cent)
	 */
	public $strengthHeading;
	
	/**
	 * @var int strength attribute: satisfaction (in per cent)
	 */
	public $strengthFreekick;
	
	/**
	 * @var int strength attribute: satisfaction (in per cent)
	 */
	public $strengthCreativity;
	
	/**
	 * @var int strength attribute: satisfaction (in per cent)
	 */
	public $strengthInfluence;
	
	/**
	 * @var int strength attribute: satisfaction (in per cent)
	 */
	public $strengthFlair;
	
	/**
	 * @var int strength attribute: pace (in per cent)
	 */
	public $strengthPace;
	 ...
	 * @var int strength attribute: satisfaction (in per cent)
	 */
	public $strengthPenalty;
	
	/**
	 * @var int strength attribute: satisfaction (in per cent)
	 */
	public $strengthPenaltyKilling;
	
	/**
	 * @var string player personality trait.
	 */
	public $personality;
	...
	private $freekicks;
	private $freekicksSuccessed;
	private $freekicksFailed;
    ...
    public function __construct($id, $team, $position, $mainPosition, 
        ...
        $strengthFlair, $strengthPace, $strengthFreekick, $strengthPenalty, $strengthPenaltyKilling, $personality = 'professional') {
    	...
    	$this->strengthPassing = $strengthPassing;
    	$this->strengthShooting = $strengthShooting;
    	$this->strengthTackling = $strengthTackling;
    	$this->strengthHeading = $strengthHeading;
    	$this->strengthInfluence = $strengthInfluence;
    	$this->strengthCreativity = $strengthCreativity;
    	$this->strengthPace = $strengthPace;
    	$this->strengthFlair = $strengthFlair;
    	$this->strengthFreekick = $strengthFreekick;
    	...
    	$this->freekicks = 0;
    	$this->freekicksSuccessed = 0;
    	$this->freekicksFailed = 0;
    	
    	if(!isset($this->mainPosition)) {
    ...
    public function recomputeTotalStrength(WebSoccer $websoccer, SimulationMatch $match) {
    	...
    	/*** The extra 10 detailed skills were all added with the same weight as strengthTech, but the denominator was not expanded.
    	$totalStrength += $this->strengthPassing * $websoccer->getConfig("sim_weight_strengthTech");
    	$totalStrength += $this->strengthShooting * $websoccer->getConfig("sim_weight_strengthTech");
    	$totalStrength += $this->strengthTackling * $websoccer->getConfig("sim_weight_strengthTech");
    	$totalStrength += $this->strengthHeading * $websoccer->getConfig("sim_weight_strengthTech");
    	$totalStrength += $this->strengthFreekick * $websoccer->getConfig("sim_weight_strengthTech");
    	$totalStrength += $this->strengthCreativity * $websoccer->getConfig("sim_weight_strengthTech");
    	$totalStrength += $this->strengthInfluence * $websoccer->getConfig("sim_weight_strengthTech");
    	$totalStrength += $this->strengthFlair * $websoccer->getConfig("sim_weight_strengthTech");
    	$totalStrength += $this->strengthPenalty * $websoccer->getConfig("sim_weight_strengthTech");
    	$totalStrength += $this->strengthPenaltyKilling * $websoccer->getConfig("sim_weight_strengthTech");
    	***/
    	...
    	// Personality effects stay in the requested 5-15% range.
    	$totalStrength = $totalStrength * PlayerPersonalityDataService::getMatchStrengthMultiplier($this->personality, $match, $this);
    ...
    /**
     *
     * @return int number of freekicks by the player.
     */
    ...
    /**
     *
     * @return int number of successful freekicks by the player.
     */
    public function getFreekicksSuccessed() {
        return $this->freekicksSuccessed;
    }
    
    /**
     *
     * @return int number of failed freekicks by the player.
     */
    public function getFreekicksFailed() {
        return $this->freekicksFailed;
    }
    
    /**
     * @param int $freekicks number of freekicks by the player
     */
    public function setFreekicks($freekicks) {
        if ($this->freekicks !== $freekicks) {
     ...
     * @param int $passesFailed number of unseccessful passes by the player
     */
    public function setFreekicksFailed($freekicksFailed) {
        if ($this->freekicksFailed !== $freekicksFailed) {
            $this->freekicksFailed = $freekicksFailed;
     ...
     * @param int $passesSuccessed number of successful passes by the player.
     */
    public function setFreekicksSuccessed($freekicksSuccessed) {
        if ($this->freekicksSuccessed !== $freekicksSuccessed) {
            $this->freekicksSuccessed = $freekicksSuccessed;
