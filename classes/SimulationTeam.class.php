...
class SimulationTeam {
	...
	/**
	 * @var int Team chemistry score in per cent.
	 */
	public $chemistryScore;

	/**
	 * @var int Small chemistry match effect, e.g. -3..+3.
	 */
	public $chemistryMatchEffect;
	
	/**
	 * @var string Club tactical style identity.
	 */
	public $tacticalStyle;

	/**
	 * @var int Tactical style fit in per cent.
	 */
	public $tacticalStyleFit;
	...
	/**
	 * @var SimulationPlayer Player who takes corners. Not always set.
	 */
	public $cornerPlayer;
    ...
    public function __construct($id, $offensive = null) {
    	...
    	$this->goals = 0;
    	$this->morale = 0;
    	$this->chemistryScore = 50;
    	$this->chemistryMatchEffect = 0;
    	$this->tacticalStyle = '';
    	...
    	$this->counterattacks = FALSE;
	    	...
	    	$this->cornerPlayer = NULL;
    	
    	$this->playersOnBench = array();
    ...
    public function removePlayer($playerToRemove) {
    	...
    	if ($this->freeKickPlayer != NULL && $this->freeKickPlayer->id == $playerToRemove->id) {
	    	...
	    	if ($this->cornerPlayer != NULL && $this->cornerPlayer->id == $playerToRemove->id) {
	    		$this->cornerPlayer = NULL;
	    	}
    }
