...
/**
 * Builds the scouting department for the manager's club.
 */
class BuildScoutingDepartmentController implements IActionController {
    private $_i18n;
    private $_websoccer;
    private $_db;
    ...
    public function executeAction($parameters) {
        ...
        try {
            ScoutingDataService::buildDepartment($this->_websoccer, $this->_db, $teamId);
        } catch (Exception $e) {
        ...
        $this->_websoccer->addFrontMessage(new FrontMessage(
            ...
            $this->_i18n->getMessage('build_scouting_department_message'),
            ''
        ));
