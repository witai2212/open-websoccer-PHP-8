...
/**
 * Rejects a temporary scouting proposal.
 */
class RejectScoutingProposalController implements IActionController {
    private $_i18n;
    private $_websoccer;
    private $_db;
    ...
    public function executeAction($parameters) {
        ...
        try {
            ScoutingDataService::rejectProposal($this->_websoccer, $this->_db, $proposalId, $teamId);
        } catch (Exception $e) {
        ...
        $this->_websoccer->addFrontMessage(new FrontMessage(
            ...
            $this->_i18n->getMessage('reject_scouting_proposal_message'),
            ''
        ));
