 ...
 */
class BuyStockModel implements IModel {
    ...
    public function getTemplateParameters() {
        ...
        $userMax = StockMarketDataService::getUsersMaxByIndex($this->_websoccer, $this->_db, $index['id'], $teamId);
        
        return array("index" => $index, "max" => $userMax);
    }
