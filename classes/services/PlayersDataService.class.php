...
class PlayersDataService {
	...
	public static function getMarketValue(WebSoccer $websoccer, DbConnection $db, $player, $columnPrefix = 'player_') {
		...
		$queryString = "SELECT w_staerke, w_technik, w_kondition, w_frische, w_zufriedenheit, w_talent
		...
		$marketvalue = $total_strength * ($player_talent/5) * $websoccer->getConfig('transfermarket_value_per_strength');
