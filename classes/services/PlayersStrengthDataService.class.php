...
class PlayersStrengthDataService {
    ...
    */
    ...
    public static function calculatePlayerStats(WebSoccer $websoccer, DbConnection $db, $playerId, $persist = true) {
        ...
        // Update database only when this is not a preview calculation.
        if ($persist) {
