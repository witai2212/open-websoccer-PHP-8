...
class ScoutingDataService {
    ...
    public static function getTeamScouts(WebSoccer $websoccer, DbConnection $db, $teamId) {
        ...
        $sqlStr = "SELECT * FROM ". $websoccer->getConfig("db_prefix") ."_scout WHERE team_id='$teamId'";
        $result = $db->executeQuery($sqlStr);
    ...
    public static function hireScout(WebSoccer $websoccer, DbConnection $db, $scoutId, $teamId) {
        ...
        $sqlStr = "UPDATE ". $websoccer->getConfig("db_prefix") ."_scout SET team_id='$teamId' WHERE id='$scoutId'";
    ...
    public static function fireScout(WebSoccer $websoccer, DbConnection $db, $scoutId, $teamId) {
        ...
        // debit amount
        BankAccountDataService::debitAmount($websoccer, $db, $teamId, $total_amount, "fire_scout_message", "scouting_abteilung");
