-- CM23 full installer schema
-- Generated from current structure dump on 2026-06-01.
-- Default prefix: ws3_. The installer replaces ws3_ with the configured prefix.

--
-- Tabellenstruktur für Tabelle `ws3_achievement`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_admin`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_aufstellung`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_badge`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_badge_event_log`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_badge_user`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_bank`
--

CREATE TABLE `ws3_bank` (
  `id` int(3) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_briefe`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_buildings_of_team`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_club_staff`
--

CREATE TABLE `ws3_club_staff` (
  `id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_club_staff_assignment`
--

CREATE TABLE `ws3_club_staff_assignment` (
  `team_id` int(10) NOT NULL,
  `role` enum('assistant_manager','goalkeeping_coach','fitness_coach','youth_coach','physio','marketing_manager','financial_advisor') NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_cl_temp`
--

CREATE TABLE `ws3_cl_temp` (
  `id` int(3) NOT NULL,
  `verein_id` int(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Tabellenstruktur für Tabelle `ws3_config`
--

CREATE TABLE `ws3_config` (
  `id` int(3) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_country`
--

CREATE TABLE `ws3_country` (
  `id` int(3) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_cup`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_cup_round`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_cup_round_group`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_cup_round_group_next`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_cup_round_pending`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_derby_match`
--

CREATE TABLE `ws3_derby_match` (
...
--
-- Tabellenstruktur für Tabelle `ws3_el_temp`
--

CREATE TABLE `ws3_el_temp` (
  `id` int(3) NOT NULL,
  `verein_id` int(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Tabellenstruktur für Tabelle `ws3_fan_mood_log`
--

CREATE TABLE `ws3_fan_mood_log` (
  `id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL,
  `event_date` int(11) NOT NULL DEFAULT 0,
  `source` enum('match','derby','ticket','transfer','youth','mission','board') NOT NULL DEFAULT 'match',
...
--
-- Tabellenstruktur für Tabelle `ws3_friendly_request`
--

CREATE TABLE `ws3_friendly_request` (
  `id` int(3) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_individual_training`
--

CREATE TABLE `ws3_individual_training` (
  `id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_injury_clearance`
--

CREATE TABLE `ws3_injury_clearance` (
  `id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
  `player_id` int(10) NOT NULL,
  `match_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_injury_log`
--

CREATE TABLE `ws3_injury_log` (
  `id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
  `player_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_injury_treatment`
--

CREATE TABLE `ws3_injury_treatment` (
  `id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
  `player_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_kontinent`
--

CREATE TABLE `ws3_kontinent` (
  `id` smallint(5) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_konto`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_kontohistory`
--

CREATE TABLE `ws3_kontohistory` (
...
--
-- Tabellenstruktur für Tabelle `ws3_land`
--

CREATE TABLE `ws3_land` (
  `id` int(5) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_leaguehistory`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_liga`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_loan`
--

CREATE TABLE `ws3_loan` (
  `id` int(10) NOT NULL,
  `player_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_loan_offer`
--

CREATE TABLE `ws3_loan_offer` (
  `id` int(10) NOT NULL,
  `player_id` int(10) NOT NULL,
  `lender_team_id` int(10) NOT NULL,
  `loan_fee_per_match` int(10) NOT NULL DEFAULT 0,
...
--
-- Tabellenstruktur für Tabelle `ws3_loan_report`
--

CREATE TABLE `ws3_loan_report` (
  `id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_loan_request`
--

CREATE TABLE `ws3_loan_request` (
  `id` int(10) NOT NULL,
  `player_id` int(10) NOT NULL,
  `lender_team_id` int(10) NOT NULL,
  `borrower_team_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_manager_career_history`
--

CREATE TABLE `ws3_manager_career_history` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL,
  `old_team_id` int(10) NOT NULL DEFAULT 0,
  `new_team_id` int(10) NOT NULL,
  `offer_id` int(10) NOT NULL DEFAULT 0,
  `origin` enum('job_offer','free_club','additional_club') NOT NULL DEFAULT 'free_club',
...
--
-- Tabellenstruktur für Tabelle `ws3_manager_job_offer`
--

CREATE TABLE `ws3_manager_job_offer` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_manager_mission`
--

CREATE TABLE `ws3_manager_mission` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
  `season_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_manager_mission_youth_promotion`
--

CREATE TABLE `ws3_manager_mission_youth_promotion` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
  `season_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_matchreport`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_merchandising_product`
--

CREATE TABLE `ws3_merchandising_product` (
  `id` int(10) NOT NULL,
  `name` varchar(100) NOT NULL,
  `description` varchar(255) DEFAULT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_merchandising_sales`
--

CREATE TABLE `ws3_merchandising_sales` (
  `id` int(10) NOT NULL,
  `match_id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_merchandising_team_product`
--

CREATE TABLE `ws3_merchandising_team_product` (
  `team_id` int(10) NOT NULL,
  `product_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_name`
--

CREATE TABLE `ws3_name` (
  `id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_nationalplayer`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_news`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_notification`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_penalty`
--

CREATE TABLE `ws3_penalty` (
  `id` int(2) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_premiumpayment`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_premiumstatement`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_randomevent`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_randomevent_chain`
--

CREATE TABLE `ws3_randomevent_chain` (
  `id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_randomevent_chain_choice`
--

CREATE TABLE `ws3_randomevent_chain_choice` (
  `id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_randomevent_chain_occurrence`
--

CREATE TABLE `ws3_randomevent_chain_occurrence` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
  `chain_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_randomevent_chain_roll`
--

CREATE TABLE `ws3_randomevent_chain_roll` (
  `team_id` int(10) NOT NULL,
  `matchday` tinyint(3) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_randomevent_occurrence`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_rivalry`
--

CREATE TABLE `ws3_rivalry` (
  `id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_saison`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_scout`
--

CREATE TABLE `ws3_scout` (
  `id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_scouting_camp`
--

CREATE TABLE `ws3_scouting_camp` (
  `id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_scouting_camp_location`
--

CREATE TABLE `ws3_scouting_camp_location` (
  `id` int(10) NOT NULL,
  `name` varchar(100) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_scouting_department`
--

CREATE TABLE `ws3_scouting_department` (
  `id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
  `level` tinyint(3) NOT NULL DEFAULT 1,
  `created_date` int(11) NOT NULL DEFAULT 0,
...
--
-- Tabellenstruktur für Tabelle `ws3_scouting_department_level`
--

CREATE TABLE `ws3_scouting_department_level` (
  `id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_scouting_proposal`
--

CREATE TABLE `ws3_scouting_proposal` (
  `id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_second_position`
--

CREATE TABLE `ws3_second_position` (
...
--
-- Tabellenstruktur für Tabelle `ws3_session`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_shoutmessage`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_spiel`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_spieler`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_spiel_berechnung`
--
...
CREATE TABLE `ws3_spiel_berechnung` (
  ...
  `w_passing` varchar(5) DEFAULT NULL,
  `w_shooting` varchar(5) DEFAULT NULL,
  `w_heading` varchar(5) DEFAULT NULL,
  `w_tackling` varchar(5) DEFAULT NULL,
  `w_creativity` varchar(5) DEFAULT NULL,
  `w_influence` varchar(5) DEFAULT NULL,
  `w_flair` varchar(5) DEFAULT NULL,
  `w_freekick` varchar(5) DEFAULT NULL,
  `w_pace` varchar(5) DEFAULT NULL,
  `w_penalty` varchar(5) DEFAULT NULL,
  `w_penalty_killing` varchar(5) DEFAULT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_spiel_text`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_sponsor`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_sponsor_contract`
--

CREATE TABLE `ws3_sponsor_contract` (
  `id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_sponsor_negotiation`
--

CREATE TABLE `ws3_sponsor_negotiation` (
  `id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
  `sponsor_id` int(10) NOT NULL,
  `season_id` int(10) NOT NULL DEFAULT 0,
...
--
-- Tabellenstruktur für Tabelle `ws3_stadion`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_stadiumbuilding`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_stadium_attendance_log`
--

CREATE TABLE `ws3_stadium_attendance_log` (
  `id` int(10) NOT NULL,
  `match_id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_stadium_builder`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_stadium_construction`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_stadium_naming_contract`
--

CREATE TABLE `ws3_stadium_naming_contract` (
  `id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_stadium_naming_payout`
--

CREATE TABLE `ws3_stadium_naming_payout` (
  `id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_stats_salary`
--

CREATE TABLE `ws3_stats_salary` (
  `id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_stockmarket`
--

CREATE TABLE `ws3_stockmarket` (
  `id` int(5) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_stockmarket_date`
--

CREATE TABLE `ws3_stockmarket_date` (
...
--
-- Tabellenstruktur für Tabelle `ws3_stockmarket_dividend`
--

CREATE TABLE `ws3_stockmarket_dividend` (
  `id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_stockmarket_dividend_payment`
--

CREATE TABLE `ws3_stockmarket_dividend_payment` (
  `id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_tabelle_markierung`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_teamoftheday`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_team_chemistry_log`
--

CREATE TABLE `ws3_team_chemistry_log` (
  `id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
  `event_date` int(11) NOT NULL DEFAULT 0,
...
--
-- Tabellenstruktur für Tabelle `ws3_team_league_statistics`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_titles_won`
--

CREATE TABLE `ws3_titles_won` (
  `id` int(5) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_trainer`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_training`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_trainingslager`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_trainingslager_belegung`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_trainingslager_report`
--

CREATE TABLE `ws3_trainingslager_report` (
  `id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_training_plan`
--

CREATE TABLE `ws3_training_plan` (
  `id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_training_plan_slot`
--

CREATE TABLE `ws3_training_plan_slot` (
  `id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_training_report`
--

CREATE TABLE `ws3_training_report` (
  `id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_training_report_player`
--

CREATE TABLE `ws3_training_report_player` (
  `id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_training_unit`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_transfer`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_transfer_angebot`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_transfer_log`
--

CREATE TABLE `ws3_transfer_log` (
  `id` int(5) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_transfer_offer`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_uefa_temp`
--

CREATE TABLE `ws3_uefa_temp` (
  `id` int(5) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_ul_temp`
--

CREATE TABLE `ws3_ul_temp` (
  `id` int(3) NOT NULL,
  `verein_id` int(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Tabellenstruktur für Tabelle `ws3_user`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_userabsence`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_useractionlog`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_user_inactivity`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_user_stock`
--

CREATE TABLE `ws3_user_stock` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL,
  `stock_id` int(10) NOT NULL,
  `qty` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_verein`
--
...
--
-- Stellvertreter-Struktur des Views `ws3_v_transfer_angebot_player`
-- (Siehe unten für die tatsächliche Ansicht)
--
CREATE TABLE `ws3_v_transfer_angebot_player` (
`offer` bigint(21)
,`spieler_id` int(10)
);
...
--
-- Tabellenstruktur für Tabelle `ws3_watchlist`
--

CREATE TABLE `ws3_watchlist` (
  `id` int(10) NOT NULL,
  `spieler_id` int(10) NOT NULL,
  `verein_id` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Tabellenstruktur für Tabelle `ws3_what_changed`
--

CREATE TABLE `ws3_what_changed` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL,
  `team_id` int(10) NOT NULL,
  `match_id` int(10) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `ws3_youthmatch`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_youthmatch_player`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_youthmatch_reportitem`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_youthmatch_request`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_youthplayer`
--
...
--
-- Tabellenstruktur für Tabelle `ws3_youthscout`
--
...
--
-- Indizes für die Tabelle `ws3_achievement`
--
ALTER TABLE `ws3_achievement`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_admin`
--
ALTER TABLE `ws3_admin`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_aufstellung`
--
ALTER TABLE `ws3_aufstellung`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_badge`
--
ALTER TABLE `ws3_badge`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_badge_event_log`
--
ALTER TABLE `ws3_badge_event_log`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_badge_user`
--
ALTER TABLE `ws3_badge_user`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_bank`
--
ALTER TABLE `ws3_bank`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_bank_team_status` (`verein_id`,`status`),
  ADD KEY `idx_bank_payment_match` (`last_payment_match_id`);

--
-- Indizes für die Tabelle `ws3_briefe`
--
ALTER TABLE `ws3_briefe`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ws3_briefe_user_id_fk` (`absender_id`);

--
-- Indizes für die Tabelle `ws3_club_staff`
--
ALTER TABLE `ws3_club_staff`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_club_staff_role_active` (`role`,`active`);

--
-- Indizes für die Tabelle `ws3_club_staff_assignment`
--
ALTER TABLE `ws3_club_staff_assignment`
  ADD PRIMARY KEY (`team_id`,`role`),
  ADD KEY `idx_club_staff_assignment_staff` (`staff_id`);

--
-- Indizes für die Tabelle `ws3_cl_temp`
--
ALTER TABLE `ws3_cl_temp`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_config`
--
ALTER TABLE `ws3_config`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_country`
--
ALTER TABLE `ws3_country`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_cup`
--
ALTER TABLE `ws3_cup`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_cup_round`
--
ALTER TABLE `ws3_cup_round`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ws3_cupround_cup_id_fk` (`cup_id`),
  ADD KEY `ws3_cupround_fromloosers_id_fk` (`from_loosers_round_id`),
  ADD KEY `ws3_cupround_fromwinners_id_fk` (`from_winners_round_id`);

--
-- Indizes für die Tabelle `ws3_cup_round_group_next`
--
ALTER TABLE `ws3_cup_round_group_next`
  ADD PRIMARY KEY (`cup_round_id`) USING BTREE,
  ADD KEY `ws3_groupnext_tagetround_fk` (`target_cup_round_id`);

--
-- Indizes für die Tabelle `ws3_cup_round_pending`
--
ALTER TABLE `ws3_cup_round_pending`
  ADD PRIMARY KEY (`team_id`,`cup_round_id`);

--
-- Indizes für die Tabelle `ws3_derby_match`
--
ALTER TABLE `ws3_derby_match`
...
--
-- Indizes für die Tabelle `ws3_el_temp`
--
ALTER TABLE `ws3_el_temp`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_fan_mood_log`
--
ALTER TABLE `ws3_fan_mood_log`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_friendly_request`
--
ALTER TABLE `ws3_friendly_request`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_individual_training`
--
ALTER TABLE `ws3_individual_training`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_injury_clearance`
--
ALTER TABLE `ws3_injury_clearance`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_injury_log`
--
ALTER TABLE `ws3_injury_log`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_injury_treatment`
--
ALTER TABLE `ws3_injury_treatment`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_injury_treatment_team_date` (`team_id`,`created_date`),
  ADD KEY `idx_injury_treatment_player` (`player_id`);

--
-- Indizes für die Tabelle `ws3_kontinent`
--
ALTER TABLE `ws3_kontinent`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_konto`
--
ALTER TABLE `ws3_konto`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_land`
--
ALTER TABLE `ws3_land`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_leaguehistory`
--
ALTER TABLE `ws3_leaguehistory`
  ADD PRIMARY KEY (`team_id`,`season_id`,`matchday`);

--
-- Indizes für die Tabelle `ws3_liga`
--
ALTER TABLE `ws3_liga`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_loan`
--
ALTER TABLE `ws3_loan`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_loan_offer`
--
ALTER TABLE `ws3_loan_offer`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_loan_offer_player_status` (`player_id`,`status`),
  ADD KEY `idx_loan_offer_lender_status` (`lender_team_id`,`status`);

--
-- Indizes für die Tabelle `ws3_loan_report`
--
ALTER TABLE `ws3_loan_report`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_loan_request`
--
ALTER TABLE `ws3_loan_request`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_manager_career_history`
--
ALTER TABLE `ws3_manager_career_history`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_manager_job_offer`
--
ALTER TABLE `ws3_manager_job_offer`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_manager_mission`
--
ALTER TABLE `ws3_manager_mission`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_manager_mission_youth_promotion`
--
ALTER TABLE `ws3_manager_mission_youth_promotion`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_matchreport`
--
ALTER TABLE `ws3_matchreport`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_auto_match_id` (`match_id`);

--
-- Indizes für die Tabelle `ws3_merchandising_product`
--
ALTER TABLE `ws3_merchandising_product`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_merchandising_sales`
--
ALTER TABLE `ws3_merchandising_sales`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_merchandising_team_product`
--
ALTER TABLE `ws3_merchandising_team_product`
  ADD PRIMARY KEY (`team_id`,`product_id`);

--
-- Indizes für die Tabelle `ws3_name`
--
ALTER TABLE `ws3_name`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_nationalplayer`
--
ALTER TABLE `ws3_nationalplayer`
  ADD PRIMARY KEY (`team_id`,`player_id`),
  ADD KEY `ws3_nationalp_player_id_fk` (`player_id`);

--
-- Indizes für die Tabelle `ws3_news`
--
ALTER TABLE `ws3_news`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_notification`
--
ALTER TABLE `ws3_notification`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_penalty`
--
ALTER TABLE `ws3_penalty`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_premiumpayment`
--
ALTER TABLE `ws3_premiumpayment`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ws3_premiumpayment_user_id_fk` (`user_id`);

--
-- Indizes für die Tabelle `ws3_premiumstatement`
--
ALTER TABLE `ws3_premiumstatement`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ws3_premium_user_id_fk` (`user_id`);

--
-- Indizes für die Tabelle `ws3_randomevent`
--
ALTER TABLE `ws3_randomevent`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_randomevent_chain`
--
ALTER TABLE `ws3_randomevent_chain`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_randomevent_chain_choice`
--
ALTER TABLE `ws3_randomevent_chain_choice`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_randomevent_chain_occurrence`
--
ALTER TABLE `ws3_randomevent_chain_occurrence`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_randomevent_chain_roll`
--
ALTER TABLE `ws3_randomevent_chain_roll`
  ADD PRIMARY KEY (`team_id`,`matchday`),
  ADD KEY `idx_randomevent_chain_roll_occurrence` (`created_occurrence_id`);

--
-- Indizes für die Tabelle `ws3_rivalry`
--
ALTER TABLE `ws3_rivalry`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_saison`
--
ALTER TABLE `ws3_saison`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_scout`
--
ALTER TABLE `ws3_scout`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_scouting_camp`
--
ALTER TABLE `ws3_scouting_camp`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_scouting_camp_location`
--
ALTER TABLE `ws3_scouting_camp_location`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_scouting_department`
--
ALTER TABLE `ws3_scouting_department`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_scouting_department_level`
--
ALTER TABLE `ws3_scouting_department_level`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_scouting_department_level` (`level`),
  ADD KEY `idx_scouting_department_level_status` (`status`);

--
-- Indizes für die Tabelle `ws3_scouting_proposal`
--
ALTER TABLE `ws3_scouting_proposal`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_session`
--
ALTER TABLE `ws3_session`
  ADD PRIMARY KEY (`session_id`);

--
-- Indizes für die Tabelle `ws3_shoutmessage`
--
ALTER TABLE `ws3_shoutmessage`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `match_id` (`match_id`);

--
-- Indizes für die Tabelle `ws3_spiel`
--
ALTER TABLE `ws3_spiel`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_auto_berechnet` (`berechnet`),
  ADD KEY `idx_auto_saison_id` (`saison_id`);

--
-- Indizes für die Tabelle `ws3_spieler`
--
ALTER TABLE `ws3_spieler`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_spiel_berechnung`
--
ALTER TABLE `ws3_spiel_berechnung`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_auto_spiel_id_team_id` (`spiel_id`,`team_id`),
  ADD KEY `idx_auto_spieler_id` (`spieler_id`);

--
-- Indizes für die Tabelle `ws3_spiel_text`
--
ALTER TABLE `ws3_spiel_text`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_sponsor`
--
ALTER TABLE `ws3_sponsor`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_sponsor_contract`
--
ALTER TABLE `ws3_sponsor_contract`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_sponsor_negotiation`
--
ALTER TABLE `ws3_sponsor_negotiation`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_stadion`
--
ALTER TABLE `ws3_stadion`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_stadiumbuilding`
--
ALTER TABLE `ws3_stadiumbuilding`
  ADD PRIMARY KEY (`id`),
  ADD KEY `required_building_id` (`required_building_id`);

--
-- Indizes für die Tabelle `ws3_stadium_attendance_log`
--
ALTER TABLE `ws3_stadium_attendance_log`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_stadium_builder`
--
ALTER TABLE `ws3_stadium_builder`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_stadium_construction`
--
ALTER TABLE `ws3_stadium_construction`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_stadium_naming_contract`
--
ALTER TABLE `ws3_stadium_naming_contract`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_stadium_naming_payout`
--
ALTER TABLE `ws3_stadium_naming_payout`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_stats_salary`
--
ALTER TABLE `ws3_stats_salary`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_stockmarket`
--
ALTER TABLE `ws3_stockmarket`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_stockmarket_dividend`
--
ALTER TABLE `ws3_stockmarket_dividend`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_stockmarket_dividend_payment`
--
ALTER TABLE `ws3_stockmarket_dividend_payment`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_dividend_payment_user` (`user_id`,`created_date`),
  ADD KEY `idx_dividend_payment_dividend` (`dividend_id`);

--
-- Indizes für die Tabelle `ws3_tabelle_markierung`
--
ALTER TABLE `ws3_tabelle_markierung`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_teamoftheday`
--
ALTER TABLE `ws3_teamoftheday`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_team_chemistry_log`
--
ALTER TABLE `ws3_team_chemistry_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_team_chemistry_log_team_date` (`team_id`,`event_date`),
  ADD KEY `idx_team_chemistry_log_match` (`match_id`);

--
-- Indizes für die Tabelle `ws3_team_league_statistics`
--
ALTER TABLE `ws3_team_league_statistics`
  ADD PRIMARY KEY (`team_id`,`season_id`),
  ADD KEY `ws3_statistics_season_id_fk` (`season_id`);

--
-- Indizes für die Tabelle `ws3_titles_won`
--
ALTER TABLE `ws3_titles_won`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_trainer`
--
ALTER TABLE `ws3_trainer`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_training`
--
ALTER TABLE `ws3_training`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_trainingslager`
--
ALTER TABLE `ws3_trainingslager`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_trainingslager_belegung`
--
ALTER TABLE `ws3_trainingslager_belegung`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ws3_trainingslager_belegung_fk` (`lager_id`),
  ADD KEY `ws3_trainingslager_verein_fk` (`verein_id`);

--
-- Indizes für die Tabelle `ws3_trainingslager_report`
--
ALTER TABLE `ws3_trainingslager_report`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_trainingslager_report_team_date` (`team_id`,`completed_date`),
  ADD KEY `idx_trainingslager_report_camp` (`camp_id`);

--
-- Indizes für die Tabelle `ws3_training_plan`
--
ALTER TABLE `ws3_training_plan`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_training_plan_team` (`team_id`),
  ADD KEY `idx_training_plan_status` (`status`);

--
-- Indizes für die Tabelle `ws3_training_plan_slot`
--
ALTER TABLE `ws3_training_plan_slot`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_training_plan_slot` (`plan_id`,`slot_no`),
  ADD KEY `idx_training_plan_slot_plan` (`plan_id`);

--
-- Indizes für die Tabelle `ws3_training_report`
--
ALTER TABLE `ws3_training_report`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_training_report_team_date` (`team_id`,`created_date`),
  ADD KEY `idx_training_report_match` (`match_id`);

--
-- Indizes für die Tabelle `ws3_training_report_player`
--
ALTER TABLE `ws3_training_report_player`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_training_report_player_report` (`report_id`),
  ADD KEY `idx_training_report_player_player` (`player_id`);

--
-- Indizes für die Tabelle `ws3_training_unit`
--
ALTER TABLE `ws3_training_unit`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_transfer`
--
ALTER TABLE `ws3_transfer`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_transfer_angebot`
--
ALTER TABLE `ws3_transfer_angebot`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ws3_transfer_angebot_user_id_fk` (`user_id`);

--
-- Indizes für die Tabelle `ws3_transfer_log`
--
ALTER TABLE `ws3_transfer_log`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_transfer_offer`
--
ALTER TABLE `ws3_transfer_offer`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_uefa_temp`
--
ALTER TABLE `ws3_uefa_temp`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_ul_temp`
--
ALTER TABLE `ws3_ul_temp`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_user`
--
ALTER TABLE `ws3_user`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_userabsence`
--
ALTER TABLE `ws3_userabsence`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `deputy_id` (`deputy_id`);

--
-- Indizes für die Tabelle `ws3_useractionlog`
--
ALTER TABLE `ws3_useractionlog`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`);

--
-- Indizes für die Tabelle `ws3_user_inactivity`
--
ALTER TABLE `ws3_user_inactivity`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ws3_user_inactivity_user_id_fk` (`user_id`);

--
-- Indizes für die Tabelle `ws3_user_stock`
--
ALTER TABLE `ws3_user_stock`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_verein`
--
ALTER TABLE `ws3_verein`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_watchlist`
--
ALTER TABLE `ws3_watchlist`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_what_changed`
--
ALTER TABLE `ws3_what_changed`
  ADD PRIMARY KEY (`id`),
...
--
-- Indizes für die Tabelle `ws3_youthmatch`
--
ALTER TABLE `ws3_youthmatch`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_youthmatch_player`
--
ALTER TABLE `ws3_youthmatch_player`
  ADD PRIMARY KEY (`match_id`,`player_id`);

--
-- Indizes für die Tabelle `ws3_youthmatch_reportitem`
--
ALTER TABLE `ws3_youthmatch_reportitem`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_youthmatch_request`
--
ALTER TABLE `ws3_youthmatch_request`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_youthplayer`
--
ALTER TABLE `ws3_youthplayer`
  ADD PRIMARY KEY (`id`);

--
-- Indizes für die Tabelle `ws3_youthscout`
--
ALTER TABLE `ws3_youthscout`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT für Tabelle `ws3_achievement`
--
ALTER TABLE `ws3_achievement`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_admin`
--
ALTER TABLE `ws3_admin`
  MODIFY `id` smallint(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_aufstellung`
--
ALTER TABLE `ws3_aufstellung`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_badge`
--
ALTER TABLE `ws3_badge`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_badge_event_log`
--
ALTER TABLE `ws3_badge_event_log`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_badge_user`
--
ALTER TABLE `ws3_badge_user`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_bank`
--
ALTER TABLE `ws3_bank`
  MODIFY `id` int(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_briefe`
--
ALTER TABLE `ws3_briefe`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_club_staff`
--
ALTER TABLE `ws3_club_staff`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_cl_temp`
--
ALTER TABLE `ws3_cl_temp`
  MODIFY `id` int(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_config`
--
ALTER TABLE `ws3_config`
  MODIFY `id` int(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_country`
--
ALTER TABLE `ws3_country`
  MODIFY `id` int(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_cup`
--
ALTER TABLE `ws3_cup`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_cup_round`
--
ALTER TABLE `ws3_cup_round`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_el_temp`
--
ALTER TABLE `ws3_el_temp`
  MODIFY `id` int(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_fan_mood_log`
--
ALTER TABLE `ws3_fan_mood_log`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_friendly_request`
--
ALTER TABLE `ws3_friendly_request`
  MODIFY `id` int(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_individual_training`
--
ALTER TABLE `ws3_individual_training`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_injury_clearance`
--
ALTER TABLE `ws3_injury_clearance`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_injury_log`
--
ALTER TABLE `ws3_injury_log`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_injury_treatment`
--
ALTER TABLE `ws3_injury_treatment`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_kontinent`
--
ALTER TABLE `ws3_kontinent`
  MODIFY `id` smallint(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_konto`
--
ALTER TABLE `ws3_konto`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_land`
--
ALTER TABLE `ws3_land`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_liga`
--
ALTER TABLE `ws3_liga`
  MODIFY `id` smallint(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_loan`
--
ALTER TABLE `ws3_loan`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_loan_offer`
--
ALTER TABLE `ws3_loan_offer`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_loan_report`
--
ALTER TABLE `ws3_loan_report`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_loan_request`
--
ALTER TABLE `ws3_loan_request`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_manager_career_history`
--
ALTER TABLE `ws3_manager_career_history`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_manager_job_offer`
--
ALTER TABLE `ws3_manager_job_offer`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_manager_mission`
--
ALTER TABLE `ws3_manager_mission`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_manager_mission_youth_promotion`
--
ALTER TABLE `ws3_manager_mission_youth_promotion`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_matchreport`
--
ALTER TABLE `ws3_matchreport`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_merchandising_product`
--
ALTER TABLE `ws3_merchandising_product`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_merchandising_sales`
--
ALTER TABLE `ws3_merchandising_sales`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_name`
--
ALTER TABLE `ws3_name`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_news`
--
ALTER TABLE `ws3_news`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_notification`
--
ALTER TABLE `ws3_notification`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_penalty`
--
ALTER TABLE `ws3_penalty`
  MODIFY `id` int(2) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_premiumpayment`
--
ALTER TABLE `ws3_premiumpayment`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_premiumstatement`
--
ALTER TABLE `ws3_premiumstatement`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_randomevent`
--
ALTER TABLE `ws3_randomevent`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_randomevent_chain`
--
ALTER TABLE `ws3_randomevent_chain`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_randomevent_chain_choice`
--
ALTER TABLE `ws3_randomevent_chain_choice`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_randomevent_chain_occurrence`
--
ALTER TABLE `ws3_randomevent_chain_occurrence`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_rivalry`
--
ALTER TABLE `ws3_rivalry`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_saison`
--
ALTER TABLE `ws3_saison`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_scout`
--
ALTER TABLE `ws3_scout`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_scouting_camp`
--
ALTER TABLE `ws3_scouting_camp`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_scouting_camp_location`
--
ALTER TABLE `ws3_scouting_camp_location`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_scouting_department`
--
ALTER TABLE `ws3_scouting_department`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_scouting_department_level`
--
ALTER TABLE `ws3_scouting_department_level`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_scouting_proposal`
--
ALTER TABLE `ws3_scouting_proposal`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_shoutmessage`
--
ALTER TABLE `ws3_shoutmessage`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_spiel`
--
ALTER TABLE `ws3_spiel`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_spieler`
--
ALTER TABLE `ws3_spieler`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_spiel_berechnung`
--
ALTER TABLE `ws3_spiel_berechnung`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_spiel_text`
--
ALTER TABLE `ws3_spiel_text`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_sponsor`
--
ALTER TABLE `ws3_sponsor`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_sponsor_contract`
--
ALTER TABLE `ws3_sponsor_contract`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_sponsor_negotiation`
--
ALTER TABLE `ws3_sponsor_negotiation`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_stadion`
--
ALTER TABLE `ws3_stadion`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_stadiumbuilding`
--
ALTER TABLE `ws3_stadiumbuilding`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_stadium_attendance_log`
--
ALTER TABLE `ws3_stadium_attendance_log`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_stadium_builder`
--
ALTER TABLE `ws3_stadium_builder`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_stadium_construction`
--
ALTER TABLE `ws3_stadium_construction`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_stadium_naming_contract`
--
ALTER TABLE `ws3_stadium_naming_contract`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_stadium_naming_payout`
--
ALTER TABLE `ws3_stadium_naming_payout`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_stats_salary`
--
ALTER TABLE `ws3_stats_salary`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_stockmarket`
--
ALTER TABLE `ws3_stockmarket`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_stockmarket_dividend`
--
ALTER TABLE `ws3_stockmarket_dividend`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_stockmarket_dividend_payment`
--
ALTER TABLE `ws3_stockmarket_dividend_payment`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_tabelle_markierung`
--
ALTER TABLE `ws3_tabelle_markierung`
  MODIFY `id` smallint(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_teamoftheday`
--
ALTER TABLE `ws3_teamoftheday`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_team_chemistry_log`
--
ALTER TABLE `ws3_team_chemistry_log`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_titles_won`
--
ALTER TABLE `ws3_titles_won`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_trainer`
--
ALTER TABLE `ws3_trainer`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_training`
--
ALTER TABLE `ws3_training`
  MODIFY `id` smallint(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_trainingslager`
--
ALTER TABLE `ws3_trainingslager`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_trainingslager_belegung`
--
ALTER TABLE `ws3_trainingslager_belegung`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_trainingslager_report`
--
ALTER TABLE `ws3_trainingslager_report`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_training_plan`
--
ALTER TABLE `ws3_training_plan`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_training_plan_slot`
--
ALTER TABLE `ws3_training_plan_slot`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_training_report`
--
ALTER TABLE `ws3_training_report`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_training_report_player`
--
ALTER TABLE `ws3_training_report_player`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_training_unit`
--
ALTER TABLE `ws3_training_unit`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_transfer`
--
ALTER TABLE `ws3_transfer`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_transfer_angebot`
--
ALTER TABLE `ws3_transfer_angebot`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_transfer_log`
--
ALTER TABLE `ws3_transfer_log`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_transfer_offer`
--
ALTER TABLE `ws3_transfer_offer`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_uefa_temp`
--
ALTER TABLE `ws3_uefa_temp`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_ul_temp`
--
ALTER TABLE `ws3_ul_temp`
  MODIFY `id` int(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_user`
--
ALTER TABLE `ws3_user`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_userabsence`
--
ALTER TABLE `ws3_userabsence`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_useractionlog`
--
ALTER TABLE `ws3_useractionlog`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_user_inactivity`
--
ALTER TABLE `ws3_user_inactivity`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_user_stock`
--
ALTER TABLE `ws3_user_stock`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_verein`
--
ALTER TABLE `ws3_verein`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_watchlist`
--
ALTER TABLE `ws3_watchlist`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_what_changed`
--
ALTER TABLE `ws3_what_changed`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_youthmatch`
--
ALTER TABLE `ws3_youthmatch`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_youthmatch_reportitem`
--
ALTER TABLE `ws3_youthmatch_reportitem`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_youthmatch_request`
--
ALTER TABLE `ws3_youthmatch_request`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_youthplayer`
--
ALTER TABLE `ws3_youthplayer`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `ws3_youthscout`
--
ALTER TABLE `ws3_youthscout`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
...
--
-- Struktur des Views `ws3_v_transfer_angebot_player`
--
DROP TABLE IF EXISTS `ws3_v_transfer_angebot_player`;

CREATE ALGORITHM=UNDEFINED SQL SECURITY INVOKER VIEW `ws3_v_transfer_angebot_player`  AS SELECT count(`ws3_transfer_angebot`.`spieler_id`) AS `offer`, `ws3_transfer_angebot`.`spieler_id` AS `spieler_id` FROM `ws3_transfer_angebot` GROUP BY `ws3_transfer_angebot`.`spieler_id` ;
...
--
-- Constraints der Tabelle `ws3_badge_user`
--
ALTER TABLE `ws3_badge_user`
  ADD CONSTRAINT `ws3_badge_user_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `ws3_user` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `ws3_badge_user_ibfk_2` FOREIGN KEY (`badge_id`) REFERENCES `ws3_badge` (`id`) ON DELETE CASCADE;

--
-- Constraints der Tabelle `ws3_briefe`
--
ALTER TABLE `ws3_briefe`
  ADD CONSTRAINT `ws3_briefe_user_id_fk` FOREIGN KEY (`absender_id`) REFERENCES `ws3_user` (`id`) ON DELETE CASCADE;

--
-- Constraints der Tabelle `ws3_cup_round`
--
ALTER TABLE `ws3_cup_round`
  ADD CONSTRAINT `ws3_cupround_cup_id_fk` FOREIGN KEY (`cup_id`) REFERENCES `ws3_cup` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `ws3_cupround_fromloosers_id_fk` FOREIGN KEY (`from_loosers_round_id`) REFERENCES `ws3_cup_round` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `ws3_cupround_fromwinners_id_fk` FOREIGN KEY (`from_winners_round_id`) REFERENCES `ws3_cup_round` (`id`) ON DELETE CASCADE;

--
-- Constraints der Tabelle `ws3_cup_round_group_next`
--
ALTER TABLE `ws3_cup_round_group_next`
  ADD CONSTRAINT `ws3_groupnext_round_fk` FOREIGN KEY (`cup_round_id`) REFERENCES `ws3_cup_round` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `ws3_groupnext_tagetround_fk` FOREIGN KEY (`target_cup_round_id`) REFERENCES `ws3_cup_round` (`id`) ON DELETE CASCADE;

--
-- Constraints der Tabelle `ws3_nationalplayer`
--
ALTER TABLE `ws3_nationalplayer`
  ADD CONSTRAINT `ws3_nationalp_player_id_fk` FOREIGN KEY (`player_id`) REFERENCES `ws3_spieler` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `ws3_nationalp_team_id_fk` FOREIGN KEY (`team_id`) REFERENCES `ws3_verein` (`id`) ON DELETE CASCADE;

--
-- Constraints der Tabelle `ws3_premiumpayment`
--
ALTER TABLE `ws3_premiumpayment`
  ADD CONSTRAINT `ws3_premiumpayment_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `ws3_user` (`id`) ON DELETE CASCADE;

--
-- Constraints der Tabelle `ws3_premiumstatement`
--
ALTER TABLE `ws3_premiumstatement`
  ADD CONSTRAINT `ws3_premium_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `ws3_user` (`id`) ON DELETE CASCADE;

--
-- Constraints der Tabelle `ws3_stadiumbuilding`
--
ALTER TABLE `ws3_stadiumbuilding`
  ADD CONSTRAINT `ws3_stadiumbuilding_ibfk_1` FOREIGN KEY (`required_building_id`) REFERENCES `ws3_stadiumbuilding` (`id`) ON DELETE SET NULL;

--
-- Constraints der Tabelle `ws3_team_league_statistics`
--
ALTER TABLE `ws3_team_league_statistics`
  ADD CONSTRAINT `ws3_statistics_season_id_fk` FOREIGN KEY (`season_id`) REFERENCES `ws3_saison` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `ws3_statistics_team_id_fk` FOREIGN KEY (`team_id`) REFERENCES `ws3_verein` (`id`) ON DELETE CASCADE;

--
-- Constraints der Tabelle `ws3_trainingslager_belegung`
--
ALTER TABLE `ws3_trainingslager_belegung`
  ADD CONSTRAINT `ws3_trainingslager_belegung_fk` FOREIGN KEY (`lager_id`) REFERENCES `ws3_trainingslager` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `ws3_trainingslager_verein_fk` FOREIGN KEY (`verein_id`) REFERENCES `ws3_verein` (`id`) ON DELETE CASCADE;

--
-- Constraints der Tabelle `ws3_transfer_angebot`
--
ALTER TABLE `ws3_transfer_angebot`
  ADD CONSTRAINT `ws3_transfer_angebot_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `ws3_user` (`id`) ON DELETE CASCADE;

--
-- Constraints der Tabelle `ws3_userabsence`
--
ALTER TABLE `ws3_userabsence`
  ADD CONSTRAINT `ws3_userabsence_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `ws3_user` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `ws3_userabsence_ibfk_2` FOREIGN KEY (`deputy_id`) REFERENCES `ws3_user` (`id`) ON DELETE SET NULL;

--
-- Constraints der Tabelle `ws3_useractionlog`
--
ALTER TABLE `ws3_useractionlog`
  ADD CONSTRAINT `ws3_useractionlog_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `ws3_user` (`id`) ON DELETE CASCADE;

--
-- Constraints der Tabelle `ws3_user_inactivity`
--
ALTER TABLE `ws3_user_inactivity`
  ADD CONSTRAINT `ws3_user_inactivity_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `ws3_user` (`id`) ON DELETE CASCADE;



-- --------------------------------------------------------
-- Initial German match report texts
-- --------------------------------------------------------
