...
if($active_session_id>=1 && $active_session_id!=$session_id) {
    ...
    // compouteother stuff (transfers, etc)
    } else {
        ...
        if (($mw_zeitstempel + 86400) < $now) {
            ...
            ScoutingDataService::reduceTeamMatches($website, $db);
            ComputerYouthTeamsDataService::execute($website, $db);
